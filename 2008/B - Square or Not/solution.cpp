...
void solve()
{
    ...
    int u = sqrt(n);
    int a=u;
    string first = s.substr(0, u);
    string last = s.substr(sz(s) - u, u);
    //print(first + " " + last);
    string compare1, compare2;
    FoF(i, 1, u) compare1.pb('1');
    compare2.pb('1');
    FoF(i, 1, u - 2) compare2.pb('0');
    compare2.pb('1');
   // print(compare1<<" " + compare2);
    if (first != last or first != compare1)
    {
        pn;
        return;
    }
