...
// ️ Created      : 27.01.2026 at 02:06:57
...
#endif
 
// Returns number of set bits (1s) in binary representation
// Examples:
// x = 0  -> 0        -> 0
// x = 1  -> 1        -> 1
// x = 2  -> 10       -> 1
...
// Returns index (0-based) of the highest set bit
// If x = 0, returns -1
// Examples:
// x = 0  -> 0        -> -1
// x = 1  -> 1        -> 0
...
// Returns index (0-based) of the lowest set bit (rightmost 1)
// If x = 0, returns -1
// Examples:
// x = 0  -> 0        -> -1
// x = 1  -> 1        -> 0
...
// x = 8  -> 1000     -> 3
// x = 12 -> 1100     -> 2
#define lowbit(x) (x == 0 ? -1 : __builtin_ctzll(x))
unsigned long long binToDec(string s) { return bitset<64>(s).to_ullong(); }
